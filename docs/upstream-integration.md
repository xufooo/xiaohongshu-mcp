...
| `9315948` #771 | go-sdk 升级 v1.4.0 + 开启 Stateless | go-sdk 已是 v1.4.0 | ⚠️ **未保留 Stateless 变更**：性能分支已恢复 SDK 默认会话行为；裸 POST/跳过 initialize 不再作为兼容保证，客户端应遵循 MCP initialize 流程 |
