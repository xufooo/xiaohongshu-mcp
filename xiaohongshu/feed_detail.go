...
var sp=null,cu=sl.parentElement;while(cu&&cu!==bst.d&&cu!==document.body){var sy=getComputedStyle(cu);var ov=sy.overflowY;if((ov==='auto'||ov==='scroll'||ov==='overlay')&&cu.clientHeight>0){sp=cu;break}cu=cu.parentElement}
